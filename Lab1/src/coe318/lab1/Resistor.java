 ...
 *
 * @author Aditya Shinde, 501189079, aditya.shinde@torontomu.ca
 */
package coe318.lab1;
...
public class Resistor {
    ...
    public Resistor(double resistance) {
        this.resistance = resistance;  // Set resistance from constructor
        this.current = 0.0;  // Initially, current is zero
        this.voltage = 0.0;  // Initially, voltage is zero
    }
    ...
    public double getPower() {
        return this.voltage * this.current;  // Power Calculation
    }
